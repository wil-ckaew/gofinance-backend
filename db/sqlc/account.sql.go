...
const deleteAccounty = `-- name: DeleteAccounty :exec
DELETE FROM accounts 
WHERE id = $1
`

func (q *Queries) DeleteAccounty(ctx context.Context, id int32) error {
	_, err := q.db.ExecContext(ctx, deleteAccounty, id)
	return err
}
